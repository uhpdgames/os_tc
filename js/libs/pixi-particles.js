(function (f) {
  ...
  return (function () {
    ...
    1                                                                  : [function (_dereq_, module, exports) {
      ...
      let Particle_1 = _dereq_("./Particle");
       ...
       */
      let AnimatedParticle = /** @class */ (function (_super) {
        __extends(AnimatedParticle, _super);

        function AnimatedParticle(emitter) {
          let _this = _super.call(this, emitter) || this;
          _this.textures = null;
          _this.duration = 0;
          _this.framerate = 0;
          _this.elapsed = 0;
        ...
        AnimatedParticle.prototype.init = function () {
          this.Particle_init();
          this.elapsed = 0;
          //if the animation needs to match the particle's life, then cacluate letiables
          if (this.framerate < 0) {
        ...
        AnimatedParticle.prototype.update = function (delta) {
          let lerp = this.Particle_update(delta);
      ...
      "use strict";
      Object.defineProperty(exports, "__esModule", {value: true});
      let ParticleUtils_1 = _dereq_("./ParticleUtils");
      let Particle_1 = _dereq_("./Particle");
      let PropertyNode_1 = _dereq_("./PropertyNode");
      ...
      let Emitter = /** @class */ (function () {
        ...
        Emitter.prototype.init = function (art, config) {
          ...
          //reset the emitter position and rotation letiables
          this.rotation = 0;
        ...
        Emitter.prototype.update = function (delta) {
          ...
          //store current position of the emitter as local letiables
          ...
          if (this._emit) {
            ...
            while (this._spawnTimer <= 0) {
              ...
              if (-this._spawnTimer < lifetime) {
                ...
                let emitPosX = void 0, emitPosY = void 0;
      ...
      Object.defineProperty(exports, "__esModule", {value: true});
      let ParticleUtils_1 = _dereq_("./ParticleUtils");
      let PropertyList_1 = _dereq_("./PropertyList");
       ...
       */
      let Particle = /** @class */ (function (_super) {
        ...
        Particle.prototype.update = function (delta) {
          ...
          if (this._doNormalMovement) {
            ...
            if (this._doSpeed) {
              ...
              if (this.maxSpeed) {
                let currentSpeed = ParticleUtils_1.default.length(this.velocity);
      ...
      "use strict";
      Object.defineProperty(exports, "__esModule", {value: true});
      let BLEND_MODES = PIXI.BLEND_MODES;
      let PropertyNode_1 = _dereq_("./PropertyNode");
      /**
      ...
      let ParticleUtils = {
        ...
        createSteppedGradient: function (list, numSteps) {
          ...
          if (typeof numSteps !== 'number' || numSteps <= 0)
            numSteps = 10;
          let first = new PropertyNode_1.default(list[0].value, list[0].time);
...
//create an actual regular expression object from the string
      let WHITELISTER = new RegExp([
        //Allow the 4 basic operations, parentheses and all numbers/decimals, as well
        //as 'x', for the letiable usage.
        "[01234567890\\.\\*\\-\\+\\/\\(\\)x ,]",
       ...
       */
      let parsePath = function (pathString) {
       ...
       */
      let PathParticle = /** @class */ (function (_super) {
       ...
       */
      let PropertyList = /** @class */ (function () {
        ...
        PropertyList.prototype.reset = function (first) {
          ...
          let isSimple = this.next && this.next.time >= 1;
          if (isSimple) {
       ...
       */
      let PropertyNode = /** @class */ (function () {
        ...
        PropertyNode.createList = function (data) {
          if (Array.isArray(data.list)) {
            ...
            let start = new PropertyNode(data.start, 0);
      ...
      "use strict";
      Object.defineProperty(exports, "__esModule", {value: true});
      let ParticleUtils_js_1 = _dereq_("./ParticleUtils.js");
      exports.ParticleUtils = ParticleUtils_js_1.default;
      let Particle_js_1 = _dereq_("./Particle.js");
      exports.Particle = Particle_js_1.default;
      let Emitter_js_1 = _dereq_("./Emitter.js");
      exports.Emitter = Emitter_js_1.default;
      let PathParticle_js_1 = _dereq_("./PathParticle.js");
      exports.PathParticle = PathParticle_js_1.default;
      let AnimatedParticle_js_1 = _dereq_("./AnimatedParticle.js");
...
// get the library itself
      let particles = _dereq_("./particles");
